...
const PROMPT = [
  ...
  '              발행한 회사와 거래처가 서로 다르면 발행한 회사를 넣고 uncertain 에 client 를 적으세요.',
  ...
  '          ※ 연도가 없으면 사진 속 발주일 연도를 씁니다. 다만 다음 해 것을 만드는',
  '             달력·다이어리는 그 해 연말에 납품하는 일이 많으니, 헷갈리면',
  '             값을 넣되 uncertain 에 dueOn 을 적으세요.',
  '          ※ 납품일이 아예 안 적힌 의뢰서가 많습니다. 그럴 때는 빈 문자열로 두고',
  '             uncertain 에 dueOn 을 적으세요. 발주일을 대신 넣지 마세요.',
